...
Vue.component('metafooter-component', {
  template: `
  ...
  <div class="card">
			<div class="row">
				<div class="col-md-5 wrapthumbnail">
					<a href="post.html">
						<div class="thumbnail" v-bind:style="{ 'background-image': 'url(' + post.thumbnail_image + ')' }">
						</div>
					</a>
				</div>
				<div class="col-md-7">
					<div class="card-block">
						...
						<h4 class="card-text" @click="emitToAdd(post)">{{ post.content }}</h4>
						<metafooter-component :post="post"></metafooter-component>
					</div>
				</div>
			</div>
		</div>
...
Vue.component('recent-post-component', {
  template: `
  <div class="card">
				<a href="post.html">
